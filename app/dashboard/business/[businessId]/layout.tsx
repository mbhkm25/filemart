...
export default function BusinessDashboardLayout({
  ...
  }, [businessId, currentBusinessId, setCurrentBusinessId])

  // Minimal guard to avoid layout mismatch while syncing context
  ...
  const navItems = [
    ...
    {
      href: `/dashboard/business/${businessId}/profile`,
      label: 'الملف التجاري',
      icon: (
        <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          <path
    ...
    {
      href: `/dashboard/business/${businessId}/gallery`,
      label: 'الصور',
      icon: (
        <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          <path
    ...
    {
      href: `/dashboard/business/${businessId}/catalog`,
      label: 'الكاتلوج',
      icon: (
        <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          <path
    ...
    {
      href: `/dashboard/business/${businessId}/plugins`,
      label: 'الإضافات',
      icon: (
        <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          <path
    ...
    <div className="min-h-screen bg-gray-50">
      <div className="flex">
        ...
        <div className="hidden md:block">
          <NavbarDesktop
            items={navItems}
            logo={<div className="text-xl font-bold text-primary-600">FileMart</div>}
          />
        </div>
